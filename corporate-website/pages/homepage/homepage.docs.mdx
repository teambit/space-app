---
description: A homepage component for Corporate Inc. website, featuring a hero section, services, and announcements.
labels: ['homepage', 'corporate']
---

## Basic Homepage

This example demonstrates the basic usage of the `Homepage` component with default configurations.

```jsx
<Homepage />
```
## Homepage with Custom Content
This example showcases the `Homepage` component with customized content for the hero section, services, and announcements.
```jsx
<Homepage
  ...
  services={[
    {
      ...
      image: 'https://images.unsplash.com/photo-1484600899469-230e8d1d59c0?ixid=M3w3MDc2NDF8MHwxfHNlYXJjaHw3fHxtYXJzJTIwdGVycmFmb3JtaW5nfGVufDF8MHx8Ymx1ZXwxNzQ3MjI0NDk5fDA&ixlib=rb-4.1.0',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixid=M3w3MDc2NDF8MHwxfHNlYXJjaHwzfHxtYXJzJTIwYWklMjBjb250cm9sfGVufDB8MHx8YmxhY2t8MTc3MTE3MDEwMHww&ixlib=rb-4.0.3',
...
/>
```
## Homepage with Split Hero and List Announcements
This example shows the `Homepage` component configured with a split hero section and announcements displayed in a list layout.
```jsx
<Homepage
